    ...
    <section className={styles.banner} aria-label="About Narayan Bali">
      ...
      <div className={`container ${styles.inner}`}>
        ...
        <p className={styles.breadcrumb}>
          ...
          <span className={styles.sep}>/</span>
          <span>Sarpa Dosha Nivarana in Srirangapatna</span>
        </p>

        {/* Title + subtitle */}
        <h1 className={styles.title}>Sarpa Dosha Nivarana in Srirangapatna – Powerful Ritual for Naga Dosha Removal </h1>
