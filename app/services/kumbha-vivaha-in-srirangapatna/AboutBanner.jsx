    ...
    <section className={styles.banner} aria-label="About Narayan Bali">
      ...
      <div className={`container ${styles.inner}`}>
        ...
        <p className={styles.breadcrumb}>
          ...
          <span className={styles.sep}>/</span>
          <span>Kumbha Vivaha in Srirangapatna</span>
        </p>

        {/* Title + subtitle */}
        <h1 className={styles.title}>Kumbha Vivaha in Srirangapatna – Powerful Ritual to Remove Manglik Dosha & Marriage Obstacles</h1>
